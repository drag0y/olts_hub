...
C-DATA (EPON, GPON).\
Полный список моделей и версий можно посмотреть в папке _docs/platforms.md_
...
В этом же файле есть переменные для логина и пароля к ОЛТам, для подключения по Telnet/SSH.
